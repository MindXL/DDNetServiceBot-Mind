...
CREATE TABLE `channel` (
  ...
  `assignee` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `disable` text COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`id`)
...
CREATE TABLE `user` (
  ...
  `usage` text COLLATE utf8mb4_general_ci,
  `timers` text COLLATE utf8mb4_general_ci,
  `onebot` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2021-04-05  5:13:49
